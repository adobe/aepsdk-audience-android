...
public class AudienceStateTests {
    ...
    public void testConstructor_whenNullDataStoreService_doesNotCrash() {
        final MockedStatic<ServiceProvider> mockedStaticServiceProvider =
    ...
    public void testGetUuid_whenSetValid_returnsValueFromPersistence() {
        when(mockNamedCollection.getString(
                        eq(AudienceTestConstants.AUDIENCE_MANAGER_SHARED_PREFS_USER_ID_KEY), any()))
                .thenReturn(UUID);
        String uuid = audienceState.getUuid();
        assertEquals(UUID, uuid);
    ...
    public void testGetVisitorProfile_whenSetValid_returnsValueFromPersistence() {
        when(mockNamedCollection.getMap(
                        AudienceTestConstants.AUDIENCE_MANAGER_SHARED_PREFS_PROFILE_KEY))
                .thenReturn(VISITOR_PROFILE);
        when(mockNamedCollection.contains(
                        AudienceTestConstants.AUDIENCE_MANAGER_SHARED_PREFS_PROFILE_KEY))
                .thenReturn(true);
        ...
        verify(mockNamedCollection)
                .getMap(eq(AudienceTestConstants.AUDIENCE_MANAGER_SHARED_PREFS_PROFILE_KEY));
    }
    ...
    public void testSetUuid_whenPrivacyOptIn_updatesPersistedValue() {
        ...
        verify(mockNamedCollection)
                .setString(
                        eq(AudienceTestConstants.AUDIENCE_MANAGER_SHARED_PREFS_USER_ID_KEY),
                        uuidCaptor.capture());
    ...
    public void testSetVisitorProfile_whenPrivacyOptIn_updatesPersistedValue() {
        ...
        verify(mockNamedCollection)
                .setMap(
                        eq(AudienceTestConstants.AUDIENCE_MANAGER_SHARED_PREFS_PROFILE_KEY),
    ...
    @Test
    public void
            testSetMobilePrivacyStatus_whenOptUnknown_doesNotClearPersistedUUIDAndVisitorProfile() {
        // setup
        audienceState.setMobilePrivacyStatus(MobilePrivacyStatus.OPT_IN);
        audienceState.setUuid(UUID);
        audienceState.setVisitorProfile(VISITOR_PROFILE);
    ...
    public void testGetStateData_returnsUUIDAndVisitorProfile() {
        ...
        assertEquals(
                VISITOR_PROFILE, DataReader.optStringMap(data, EVENT_DATA_VISITOR_PROFILE, null));
    }
