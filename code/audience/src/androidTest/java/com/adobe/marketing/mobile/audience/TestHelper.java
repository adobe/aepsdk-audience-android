...
public class TestHelper {
    ...
    private static final ArrayList<String> knownDatabases =
                ...
                new Event.Builder(
                        ...
                        .setEventData(
                                new HashMap<String, Object>() {
                                    {
                                        put(
                                                AudienceTestConstants.EventDataKey.STATE_OWNER,
                                                stateOwner);
                                    }
                                })
                        .build();
    ...
    public static void resetKnownDatabases() {
        for (String database : knownDatabases) {
            DataQueue db =
                    ServiceProvider.getInstance().getDataQueueService().getDataQueue(database);
            db.clear();
        }
    }
