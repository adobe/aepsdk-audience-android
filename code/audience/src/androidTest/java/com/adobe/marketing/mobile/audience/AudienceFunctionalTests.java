...
public class AudienceFunctionalTests {
    ...
    private final Map<String, String> signalData =
    ...
    @Test
    public void testGetVisitorProfile_whenVisitorProfileInPersistence_returnsValue()
            throws Exception {
        // setup
    ...
    @Test
    public void
            testSubmitSignal_when_NetworkHasUnrecoverableError_thenCallbackCalledWithEmptyProfile()
                    throws Exception {
        TestableNetworkRequest signalRequest =
                new TestableNetworkRequest("https://server/event", HttpMethod.GET);
        testableNetworkService.setResponseConnectionFor(
                signalRequest, new MockConnection(404, null));
    ...
    public void testAudienceReset_shouldClearAllAudienceData() {
        ...
        assertNull(
                TestPersistenceHelper.readPersistedData(
                        AudienceTestConstants.DataStoreKey.AUDIENCE_DATASTORE, "AAMUserId"));
        assertNull(
                TestPersistenceHelper.readPersistedData(
                        AudienceTestConstants.DataStoreKey.AUDIENCE_DATASTORE, "AAMUserProfile"));
    }
    ...
    public void testLifecycleResponseEvent_AndAAMForwardingEnabled_thenShouldNotSendRequest() {
        ...
        testableNetworkService.setExpectedNetworkRequest(
                new TestableNetworkRequest("https://server/event", HttpMethod.GET), 1);
    ...
    @Test
    public void testLifecycleResponseEvent_AndAAMForwardingDisabled_thenShouldSendRequest()
            throws Exception {
        // setup
        testableNetworkService.setExpectedNetworkRequest(
                new TestableNetworkRequest("https://server/event", HttpMethod.GET), 1);
        ...
        // verify
        testableNetworkService.assertNetworkRequestCount();
        List<TestableNetworkRequest> networkRequests =
    ...
    @Test
    public void testSubmitSignalTwice_then_ConfigUpdate_shouldSendRequestTwiceInOrder()
            throws Exception {
        // setup expectations
        testableNetworkService.setExpectedNetworkRequest(
                new TestableNetworkRequest("https://server/event", HttpMethod.GET), 2);
        mockUUIDInPersistence();
    ...
    @Test
    public void
            testSubmitSignal_AndLifecycleResponseEvent_AndConfigWithAAMForwardingEnabled_thenShouldSendSignalAndIgnoreLifecycle()
                    throws Exception {
        // setup
        TestableNetworkRequest signalRequest =
                new TestableNetworkRequest("https://server/event", HttpMethod.GET);
        ...
        testableNetworkService.assertNetworkRequestCount();
        List<TestableNetworkRequest> requests =
                testableNetworkService.getReceivedNetworkRequestsMatching(signalRequest);
    ...
    @Test
    public void
            testSubmitSignal_AndLifecycleResponseEvent_AndConfigWithAAMForwardingDisabled_thenShouldSendTwoRequestsInCorrectOrder()
                    throws Exception {
        // setup
        TestableNetworkRequest signalRequest =
                new TestableNetworkRequest("https://server/event", HttpMethod.GET);
    ...
    @Test
    public void
            testLifecycleEvent_AndSubmitSignal_AndConfigUpdate_thenShouldSendTwoRequestsInCorrectOrder()
        ...
        // verify that no network call is made
        assertEquals(
                0, testableNetworkService.getReceivedNetworkRequestsMatching(signalRequest).size());
    ...
    @Test
    public void testSubmitSignal_WhenEverythingIsSetAndServerResponse_updatesSharedState()
            throws Exception {
        // setup
        TestableNetworkRequest signalRequest =
                new TestableNetworkRequest("https://server/event", HttpMethod.GET);
        ...
        assertEquals(
                "19994521975870785742420741570375407533",
                DataReader.optString(sharedState, "uuid", null));
    }

    @Test
    public void testSubmitSignal_when_PrivacyUnknown_Then_PrivacyChangesToOptIN_ShouldSendTwoHits()
            throws Exception {
        TestableNetworkRequest signalRequest =
                new TestableNetworkRequest("https://server/event", HttpMethod.GET);
        testableNetworkService.setResponseConnectionFor(
    ...
    @Test
    public void testSubmitSignal_when_PrivacyUnknown_Then_PrivacyChangesToOptOUT_ShouldClearHits()
            throws Exception {
        TestableNetworkRequest signalRequest =
                new TestableNetworkRequest("https://server/event", HttpMethod.GET);
        testableNetworkService.setResponseConnectionFor(
        ...
        TestableNetworkRequest optoutRequest =
                new TestableNetworkRequest("https://server/demoptout.jpg", HttpMethod.GET);
        ...
        assertEquals(
                0, testableNetworkService.getReceivedNetworkRequestsMatching(signalRequest).size());
        assertEquals(
                1, testableNetworkService.getReceivedNetworkRequestsMatching(optoutRequest).size());
        assertEquals(
                "The Network hit should have been the AAM optout hit!",
                "https://server/demoptout.jpg?d_uuid=testUUID",
                testableNetworkService
                        .getReceivedNetworkRequestsMatching(optoutRequest)
                        .get(0)
                        .getUrl());
    ...
    public void test_RulesResponseEvent_when_NotAAM_then_shouldNotSendRequest() {
        // setup expectations
        testableNetworkService.setExpectedNetworkRequest(
                new TestableNetworkRequest("https://audience.server", HttpMethod.GET), 1);
                ...
                testableNetworkService
                        .getReceivedNetworkRequestsMatching(
                                new TestableNetworkRequest(
                                        "https://audience.server", HttpMethod.GET))
                        .isEmpty());
    }
    ...
    private void mockUUIDInPersistence() {
        TestPersistenceHelper.updatePersistence(
                AudienceTestConstants.DataStoreKey.AUDIENCE_DATASTORE, "AAMUserId", "testUUID");
    }
    ...
    private Event createNonAAMRulesResponseEvent() {
        ...
        return new Event.Builder(
                        "Rules Event", EventType.RULES_ENGINE, EventSource.RESPONSE_CONTENT)
                .setEventData(eventData)
                .build();
    }
    ...
    void registerExtensions(final Map<String, Object> config) {
        try {
            TestHelper.registerExtensions(
                    Arrays.asList(
                            MonitorExtension.EXTENSION, Audience.EXTENSION, Identity.EXTENSION),
                    config);
        } catch (InterruptedException e) {
